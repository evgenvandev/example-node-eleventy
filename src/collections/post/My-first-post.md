...
![Первый скриншот сайта](/assets/img/first_screenshot_of_site.png "Первый запуск сайта")
...
Теперь давайте фактически создадим папку `src` и переместим файл `index.md` в папку `src`. Мы также можем удалить старую 
...
![Шаблон страницы поста](/assets/img/template-page-1.png "Шаблон страницы поста")
...
![Используем макет base.njk](/assets/img/template-using-layout-1.jpg "Используем макет base.njk")
...
![Добавление файла style.css](/assets/img/add_style_css_to_site.png "Добавление файла style.css в тег <link />")
