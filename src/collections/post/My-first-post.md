...
![Первый скриншот сайта](/example-node-eleventy/static/img/my-first-post/first_screenshot_of_site.png "Первый запуск сайта")
...
![Шаблон страницы поста](/example-node-eleventy/static/img/my-first-post/template-page-1.png "Шаблон страницы поста")
...
![Используем макет base.njk](/example-node-eleventy/static/img/my-first-post/template-using-layout-1.jpg "Используем макет base.njk")
...
![Добавление файла style.css](/example-node-eleventy/static/img/my-first-post/add_style_css_to_site.png "Добавление файла style.css в тег <link />")
